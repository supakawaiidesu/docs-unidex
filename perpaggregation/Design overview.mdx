...
One of the key unique features of our protocol is our focus on aggregation. Since 2021, we've been aggregating external perp protocols like XVIX, Gambit, Perpetual protocol, and GMX.
Since then, we've expanded our aggregation to include more protocols like MUX, GMX Forks, and GMXv2.

## How It works
One of the main key features is how we let the user tap into these external protocols. User has a few onboarding choices to decide the orderflow of his trade based on his risk appetite.
