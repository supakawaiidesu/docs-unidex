...
## Staking?
Fee distributions are done automatically by keepers without staking staking. Holding the token currently is all the user needs to do in order to be eligible for sharing.
